...
from backend.app.core.logger import logger, current_job_id, current_stage_name
...
class StageContext:
    ...
    log_callback: Optional[Callable[[str, str, str], Any]] = None
    partial_3d_callback: Optional[Callable[[Dict[str, Any]], Any]] = None
